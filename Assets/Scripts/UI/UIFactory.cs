...
{
    /// <summary>Helpers to build a legacy-uGUI interface entirely from code.</summary>
    public static class UIFactory
    {
        ...
        public static void SetAnchoredRect(RectTransform rt, Vector2 anchorMin, Vector2 anchorMax, Vector2 offsetMin, Vector2 offsetMax)
        {
